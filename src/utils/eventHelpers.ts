...
import { ButtonInteraction, Client, ModalSubmitInteraction, TextChannel } from "discord.js"
...
export async function promoteWaitlistFIFO(eventId: number, eventTitle: string, client: Client): Promise<void> 
{
...
export async function updateEventMessage(eventId: number, client: Client, isNewEvent: boolean = false): Promise<any>
{
